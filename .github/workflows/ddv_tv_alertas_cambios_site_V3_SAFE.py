#!/usr/bin/env python3
# DDV TV/Plataformas Cambios v3 SAFE — mail claro vía endpoint del sitio.
...
def post_site(subject: str, body: str, count: int) -> bool:
    ...
    payload = json.dumps(
        {
            "mode": "tv_platform_changes_clear_v3",
            "subject": subject,
            "body": body,
            "alerts_count": count,
            "source": "github-actions-ddv-radar-cambios-site-mail-v3",
        },
        ensure_ascii=False,
    ).encode("utf-8")
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "ddv-radar-cambios-site-mail-v3",
        },
    )
...
def main() -> int:
    ...
    base = {
        "version": "DDV_TV_CAMBIOS_MAIL_SITE_V3_CLEAR_SAFE",
