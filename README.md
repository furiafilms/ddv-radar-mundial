...
- Si encuentra coincidencias nuevas, crea un Issue en este repositorio.
- No toca Neolo.
- No usa FTP.
- No usa claves TMDb.
...
5. Revisar si se creó un Issue o si hay un artefacto `ddv-radar-results`.
...
- Afinar alias para evitar falsos positivos.
- Sumar fuentes por país.
- Sumar plataformas con TMDb / Watch providers.
- Sumar theatrical básico con release dates.
- Recién después conectar con Neolo por FTP o API.
